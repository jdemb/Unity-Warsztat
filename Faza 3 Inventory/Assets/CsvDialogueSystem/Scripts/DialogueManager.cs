...
public class DialogueManager : MonoBehaviour
{
	...
	public GameObject coinInteractable;
	public GameObject gate;
	public GameObject gateInteractable;
    ...
    public void StartDialogue(TextAsset csvFile)
    {
        ...
        string page;
        page = CsvParser.Instance.GetPage("Common", dialogueCsv);                  // Find start page named "Welcome"
        if (page != null)
        {
            ...
            foreach (string line in lines)
            {
                ...
                if (lineName == "Effect")                                           // Find lines named "Effect"
                {
                    ...
                    if (CsvParser.Instance.GetTextValue(out data, lineName, line) == true)
                    {
                        ...
                        {
							coin.SetActive(true);
							coinInteractable.SetActive(true);
							continue;
                        }
                        ///
                        /// Example: add food
                        ...
                        else if (data == "BlockIt")
                        {
							...
							gateInteractable.SetActive(false);
